...
|--------|------------------------|------------|
| CLASSPAGE-002 | As a user, I want to toggle visibility of specific class information fields (e.g., Instructor, Office, Time). | Done |
| CLASSPAGE-003 | As a user, I want to toggle the public/private visibility of a class directly from its page. | Done |
| ERROR-HANDLING-001 | As a developer, I want to implement centralized frontend error handling for connection/permission issues. | Done |
| PROFILE-002 | As a user, I want to toggle visibility of specific profile information fields on my profile page. | Done |
...
| CLASS-MEMBERSHIP-001 | **[Consolidated] Class Membership**: Ability to view members, invite others, and receive notifications. | In Progress |
| CLASS-SHARE-001 | As a user, I want to be able to share my classes to other users via generated links. | In Progress |
| CLASSPAGE-001 | **[Consolidated] Class Resource Management**: Support for formatted notes and folder organization. | In Progress |
| COMMENT-001 | As a user, I would like to comment on videos. | In Progress |
| DASHBOARD-001 | **[Consolidated] Recommendation Engine**: Algorithm to display prioritized, relevant content. | In Progress |
| DASHBOARD-002 | **[Dashboard Refactor]**: View recently uploaded content and visited classes. | In Progress |
| DOCUMENT-001 | As a user, I want to preview documents (PDFs) directly in the browser. | In Progress |
...
| ONBOARDING-001 | **[Consolidated] User Onboarding Flow**: Interactive walkthrough and tutorials for first-time users. | In Progress |
| PERFORMANCE-001 | As a developer, I want to index frequently queried fields in Firestore. | In Progress |
| PERFORMANCE-002 | As a developer, I want to implement caching strategies for frequently accessed data. | In Progress |
| PERMISSIONS-001 | As a developer, I want to implement role-based permissions (Professors vs Students). | In Progress |
| PROFILE-001 | **[Consolidated] Public Profiles**: View user activity and manage profile visibility. | In Progress |
...
| **ID** | **User Story / Task** | **Status** |
|--------|------------------------|------------|
| ADMIN-ENHANCE-001 | Explore AI-assisted moderation and auto-flagging capabilities for content. | Deferred |
| ADMIN-ENHANCE-002 | Explore implementing usage heatmaps and granular moderator roles. | Deferred |
| ADMIN-ENHANCE-003 | Explore backup solutions for critical platform data. | Deferred |
| DEFERRED-API-001 | [Legacy] Implement rate limiting on API endpoints. | Deferred |
| DEFERRED-API-002 | [Legacy] Log API requests and errors (Use Firebase Console instead). | Deferred |
